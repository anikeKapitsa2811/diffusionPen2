...
baseModelDir = "/cluster/datastore/aniketag/allData/diffPen/models/icdar2025/rebutal/CVL/" 

dataset_folder = '/cluster/datastore/aniketag/allData/CVL/allCrops_preprocess/'
...
ckptModelName =[
                "4head_res_CVL_DiffPen.pt"][0]

emaModelName  = [
                "4head_ema_res_CVL_DiffPen.pt"][0]

styleModel = ["CVL_classification_mobilenetv2_100.pth","mixed_CVL_mobilenetv2_100.pth","triplet_CVL_mobilenetv2_100.pth"]
styleClssifierModelPath = baseModelDir+"/style_models/"+styleModel[0]
#/cluster/datastore/aniketag/allData/diffPen/models/icdar2025/rebutal/CVL//style_models/triplet_CVL_mobilenetv2_100.pth
